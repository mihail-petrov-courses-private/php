## Въведение
Здравейте малки котки, ако четете това съобщение значи сте част от курса по разработка на Web приложения с PHP, на учебен център НЕТ ИТ. Моля запознайте се с организационните правила които ще се ползват за управление на файловете и папките в които ще се съдържа кода, който разработваме в рамките на упражненията. 
...
- {**course-activity-number**} съответства на Петък (1) или Неделя (2)
...
- [XAMP](https://www.apachefriends.org/index.html)  набор от полезни инструменти
- [Net Beans](https://netbeans.org/)                среда за разработка на PHP код

## Контакти и информация 
Ако имате допълнителни въпроси, официалният имейл за кореспонденция с мен по темите на този курс е **netitphp@mihail-petrov.me**