...
class ProductModel {
    ...
    public static function getAllProducts($filterCollection, $limitCollection) {
        return Database::select('tb_products')::where($filterCollection)::limit($limitCollection)::fetch();
    }
