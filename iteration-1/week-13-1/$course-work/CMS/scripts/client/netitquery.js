(function() {
    ...
    var baseUrlTransform = function(url) {
        ...
        if(queryParameter) {
            return `http://localhost/CMS/_routes.php?endpoint=${endpoint}&method=${method}&${queryParameter}`;
        }
        
        
        if(requestId) {
            return `http://localhost/CMS/_routes.php?endpoint=${endpoint}&method=${method}&id=${requestId}`;
        }
